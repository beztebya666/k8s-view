 ...
 *  Fully inline-styled so it renders identically regardless of the app's CSS. */
export function DemoBanner() {
  ...
  const link: React.CSSProperties = { color: "#a1a1aa", textDecoration: "none" };
  return (
    <div style={wrap}>
      ...
      <button style={btn} onClick={reset} disabled={busy} title="Wipe your changes and restore the seeded demo data">
        {busy ? "Resetting…" : "Reset demo"}
      </button>
      <a style={link} href="https://github.com/beztebya666/k8s-view" target="_blank" rel="noreferrer">GitHub ↗</a>
    </div>
  );
}
